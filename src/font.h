...
MD_MAX72XX::fontType_t ClockFont[] PROGMEM = {
    ...
    5, 0, 4, 2, 127, 0,         // 49 - '1' <- equal width as every number
    ...
    5, 34, 20, 42, 20, 8, // 187 - '» Right-pointing double angle
                          // quotation mark'
    8, 64, 47, 16, 8, 4, 30, 17,
    124, // 188 - '¼ Vulgar fraction one quarter'
    8, 64, 47, 16, 8, 4, 98, 85,
    ...
    5, 58, 69, 68, 69, 58,   // 212 - 'Ô Latin Capital letter O with
                             // circumflex'
    5, 56, 70, 69, 70, 57,   // 213 - 'Õ Latin Capital letter O with tilde'
    5, 56, 69, 68, 69, 56,   // 214 - 'Ö Latin Capital letter O with
                             // diaeresis'
    ...
    5, 60, 66, 65, 66, 60,   // 219 - 'Û Latin Capital Letter U with
                             // circumflex'
    5, 60, 65, 64, 65, 60,   // 220 - 'Ü Latin Capital Letter U with
                             // diaeresis'
